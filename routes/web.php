...
Route::get('/rapport-commandes/pdf', [App\Http\Controllers\CommandesController::class, 'generatePDF'])->name('rapport-commandes.pdf');
Route::get('/rapport-achats/pdf', [App\Http\Controllers\AchatsController::class, 'generatePDF'])->name('rapport-achats.pdf');

Route::get('/rapport-commandes/excel', [App\Http\Controllers\CommandesController::class, 'exportExcel'])->name('rapport-commandes.excel');
Route::get('/rapport-achats/excel', [App\Http\Controllers\AchatsController::class, 'exportExcel'])->name('rapport-achats.excel');
